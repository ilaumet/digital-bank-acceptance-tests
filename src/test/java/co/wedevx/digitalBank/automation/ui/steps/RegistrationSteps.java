...
public class RegistrationSteps {
    ...
    public void user_should_see_the_required_field_error_message(String fieldName, String expectedErrorMessage){
        ...
        assertEquals(expectedErrorMessage,actualErrorMessage,"the error message of required " +fieldName + " field mismatched");
    }
    ...
    public void theFollowingUserInfoShouldBeSavedInTheDb(List<Map <String,String>> expectedUserProfileInfoInDBList) {
      ...
      //  assertEquals(expectedUserInfoMap.get("dob"),actualUserProfileInfoMap.get("dob"), "registration generated wrong dob");
        ...
        assertEquals(expectedUserInfoMap.get("enabled"),String.valueOf(actualUserInfoMap.get("enabled")),"acc enabled mismatch upon registration");
        assertEquals(expectedUserInfoMap.get("email"),actualUserInfoMap.get("username"),"email mismatch upon registration");
    ...
    public void theUserWithIsNotInDB(String email) {
        ...
        String queryToGetNextValInHibernatesSeqTable = String.format("select * from hibernate_sequence");
        nextValList = DBUtils.runSQLSelectQuery(queryToGetNextValInHibernatesSeqTable);

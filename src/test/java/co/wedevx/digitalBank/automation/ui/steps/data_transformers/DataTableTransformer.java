...
public class DataTableTransformer {
    ...
    public AccountCard accountCardEntry (Map<String,String> entry){
        ...
        double balance = Double.parseDouble(entry.get("balance").replace("$", ""));
    ...
    public BankTransaction transactionEntry (Map<String,String> entry){
        ...
        double amount = Double.parseDouble(entry.get("amount").replace("$", "").replace(",", "."));
        double balance = Double.parseDouble(entry.get("balance").replace("$", "").replace(",", "."));
